...
void moveImage(sec_g2d_t *g2d, int toX, int toY, unsigned int srcAddr, unsigned int dstAddr, unsigned int tempAddr, unsigned int temp2, int width, int height)
{
